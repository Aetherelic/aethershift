...
bash "$HOME/.config/hypr/scripts/generate-kitty-theme.py" >/dev/null 2>&1 || true

bash "$HOME/.config/hypr/scripts/generate-rofi-glass-theme.py" >/dev/null 2>&1 || true

bash "$HOME/.config/hypr/scripts/generate-hypr-theme.py" >/dev/null 2>&1 || true

bash "$HOME/.config/hypr/scripts/generate-hyprlock-theme.py" >/dev/null 2>&1 || true
"$HOME/.config/hypr/scripts/generate-rofi-theme.py" >/dev/null 2>&1
