...
ShellRoot {
   ...
   GlobalShortcut {
       ...
       description: "Toggle vroomies dashboard"
       onPressed: dashboardState.show = !dashboardState.show
   }

   GlobalShortcut {
       name: "musicToggle"
       description: "Toggle vroomies music panel"
       onPressed: root.musicVisible = !root.musicVisible
   }
}
